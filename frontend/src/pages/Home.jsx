...
const Homepage = () => {
  ...
  return (
    <div className="w-full min-h-screen font-sans">
      <Header />
      {/* Hero Section */}
      <header className="flex flex-col md:flex-row items-center justify-between py-16 px-10 gap-10 bg-teal-100">
        {/* Left Text Section */}
        <div className="max-w-2xl space-y-6 text-left">
          <span className="text-white text-lg font-semibold bg-blue-600 px-4 py-2 rounded-xl">
            Experience
          </span>
        ...
        <div className="flex gap-5">
          {images.map((img, index) => (
            <motion.img
              ...
              animate={{
                scale: index === activeIndex ? 1.2 : 0.9, // Active image is bigger
                opacity: index === activeIndex ? 1 : 0.5, // Inactive images fade
              }}
