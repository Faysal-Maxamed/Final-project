        ...
        <div className="relative z-10 w-full max-w-lg px-6 py-10">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6 items-center justify-center bg-white bg-opacity-90 rounded-md shadow-xl p-6 md:p-8">
            ...
            <div className="flex flex-col w-full">
              ...
              <input type="number" name="num_procedures" value={formData.num_procedures} onChange={handleChange} required min="0"
            ...
            <div className="flex flex-col w-full">
              ...
              <input type="number" name="days_in_hospital" value={formData.days_in_hospital} onChange={handleChange} required min="0"
